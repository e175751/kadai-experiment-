...
\section{Task1}
\lstinputlisting[language=SH, numbers=left, breaklines=true, basicstyle=\ttfamily\footnotesize, frame=single, caption=ex1, label=pg:optiontask]{ex1.sh}
\begin{figure}[htbp]
	\centering
...
\section{Task2}
\lstinputlisting[language=SH, numbers=left, breaklines=true, basicstyle=\ttfamily\footnotesize, frame=single, caption=ex2, label=pg:optiontask]{ex2.sh}
\begin{figure}[htbp]
	\centering
...
\section{Task3}
\lstinputlisting[language=SH, numbers=left, breaklines=true, basicstyle=\ttfamily\footnotesize, frame=single, caption=ex3, label=pg:optiontask]{ex3.sh}
\begin{figure}[htbp]
	\centering
